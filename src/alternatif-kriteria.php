    ...
    <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Nilai Alternatif Kriteria</a>
          </div>
  ...
  <tr>
    <td align="center" valign="top" bgcolor="#FFFFFF"><br />
      ...
      <table width="900" border="0" cellpadding="5" cellspacing="1" bgcolor="#000099">
        <tr>
          <td width="189" bgcolor="#FFFFFF">ID Alternatif Kriteria</td>
          <td width="226" bgcolor="#FFFFFF">Nama Alternatif</td>
          <td width="217" bgcolor="#FFFFFF">Nama Kriteria</td>
          <td width="126" bgcolor="#FFFFFF">Nilai</td>
          <td width="86" bgcolor="#FFFFFF"><a href="add-alternatif-kriteria.php">Add</a></td>
        </tr>
        <?php
		...
		?>
        <tr>
          <td bgcolor="#FFFFFF"><?php echo $dataalternatifkriteria['id_alternatif_kriteria']; ?></td>
          <td bgcolor="#FFFFFF"><?php echo $dataalternatif['nama_alternatif']; ?></td>
          <td bgcolor="#FFFFFF"><?php echo $datakriteria['nama_kriteria']; ?></td>
          <td bgcolor="#FFFFFF"><?php echo $dataalternatifkriteria['nilai']; ?></td>
          <td bgcolor="#FFFFFF"><a href="edit-alternatif-kriteria.php?id_alternatif_kriteria=<?php echo $dataalternatifkriteria['id_alternatif_kriteria']; ?>">Edit</a> <a href="del-alternatif-kriteria.php?id_alternatif_kriteria=<?php echo $dataalternatifkriteria['id_alternatif_kriteria']; ?>">Del</a></td>
        </tr>
        <?php
			}
		?>
