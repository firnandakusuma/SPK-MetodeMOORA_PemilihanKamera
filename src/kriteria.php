    ...
    <td align="center" valign="top" bgcolor="#FFFFFF"><br />
      ...
      <table width="700" border="0" cellpadding="5" cellspacing="1" bgcolor="#000099">
        <tr>
          ...
          <td width="129" bgcolor="#FFFFFF">Bobot</td>
          <td width="140" bgcolor="#FFFFFF">Tipe</td>
        ...
        <tr>
          ...
          <td bgcolor="#FFFFFF"><?php echo $datakriteria['bobot']; ?></td>
          <td bgcolor="#FFFFFF"><?php echo $datakriteria['tipe']; ?></td>
          <td bgcolor="#FFFFFF"><a href="edit-kriteria.php?id_kriteria=<?php echo $datakriteria['id_kriteria']; ?>">Edit</a> <a href="del-kriteria.php?id_kriteria=<?php echo $datakriteria['id_kriteria']; ?>">Del</a></td>
        </tr>
        <?php
			}
		?>
