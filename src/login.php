          ...
          <div class="col-md-12">
            <div class="card">
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-md-1" >
                      <div class="form-group" >
                        ...
                        <input class="form-control" input type="text" name="username" id="username">
                      </div>
                    </div>
                  </div>
                  <div class="row">
              ...
              <div class="card-footer">
                <button type="submit" name="button" id="button" class="btn btn-fill btn-primary" value="Login">Login</button>
              </div>
            </div>
          </div>
        </table>
