<?php
	...
	{
		mysqli_query($db, "UPDATE kriteria SET nama_kriteria='$_POST[nama_kriteria]', bobot='$_POST[bobot]', tipe='$_POST[tipe]' WHERE id_kriteria='$_POST[id_kriteria]'");
    ...
    <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Kriteria</a>
          </div>
      ...
      <form id="form1" name="form1" method="post" action="">
        <table width="350" border="0" cellpadding="5" cellspacing="1" bgcolor="#000099">
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF"><input type="text" name="bobot" id="bobot" value="<?php echo $datakriteria['bobot']; ?>" /></td>
          </tr>
          <tr>
            <td bgcolor="#FFFFFF">Tipe</td>
            <td bgcolor="#FFFFFF"><select name="tipe" id="tipe">
              <option value=""></option>
              <option value="cost" <?php if ($datakriteria['tipe'] == 'cost') { echo " selected"; } ?>>Cost</option>
              <option value="benefit" <?php if ($datakriteria['tipe'] == 'benefit') { echo " selected"; } ?>>Benefit</option>
            </select></td>
          </tr>
          <tr>
