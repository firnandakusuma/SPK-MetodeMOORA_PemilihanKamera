    ...
    <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Analisa MOORA 3</a>
          </div>
...
<form name="form1" method="post" action=""><br>
  ...
  <table align="center" width="400" border="1" cellspacing="0" cellpadding="5">
  <tr>
  <td id="ignore" bgcolor="#DBEAF5" width="400" colspan="2"><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"><font size="2">PILIH ALTERNATIF</font> </font></strong></div></td>
  <?php
...
else 
{
	...
	$alternatif = array(); //array("Opo", "Xiomey", "Zenpon", "Xpera", "Glaxy", "Vio", "Ipone");
	...
	$kriteria = array(); //array("RAM", "Kamera", "Storage", "Harga", "Ketebalan");
	
	$tipe = array(); //array("benefit", "benefit", "benefit", "cost", "cost");
