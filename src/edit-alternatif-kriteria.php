      ...
      <form id="form1" name="form1" method="post" action="">
        <table width="400" border="0" cellpadding="5" cellspacing="1" bgcolor="#000099">
          <tr>
            ...
            <td bgcolor="#FFFFFF"><input type="text" name="id_alternatif_kriteria" id="id_alternatif_kriteria" readonly value="<?php echo $dataalternatifkriteria['id_alternatif_kriteria']; ?>" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF"><input type="text" name="nilai" id="nilai" value="<?php echo $dataalternatifkriteria['nilai']; ?>" /></td>
          </tr>
          <tr>
