<?php
	...
	{
		mysqli_query($db, "INSERT INTO alternatif_kriteria(id_alternatif, id_kriteria, nilai) VALUES('$_POST[id_alternatif]', '$_POST[id_kriteria]', '$_POST[nilai]')");
    ...
    <td align="center" valign="top" bgcolor="#FFFFFF"><br />
      ...
      <form id="form1" name="form1" method="post" action="">
        <table width="350" border="0" cellpadding="5" cellspacing="1" bgcolor="#000099">
          ...
          <tr>
            <td width="128" bgcolor="#FFFFFF">Kriteria</td>
